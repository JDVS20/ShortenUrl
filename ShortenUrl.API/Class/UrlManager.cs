...
namespace ShortenUrl.API.Class
{
    public class UrlManager : IDisposable
    {
        private ShortenUrl.API.Class.IRepository<ShortenUrl.API.Class.Models.ShortUrl> dataRepository;
        private bool disposing = false;

        public UrlManager()
        {
            //dataRepository = new System.Data.UrlRepository();
        }
